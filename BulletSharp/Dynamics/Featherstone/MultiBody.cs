...
namespace BulletSharp
{
	public class MultiBody : IDisposable
	{
		...
		public MultiBody(int nLinks, Scalar mass, Vector3 inertia, bool fixedBase,
			bool canSleep)
		{
		...
		public void AddJointTorque(int i, Scalar q)
		{
			btMultiBody_addJointTorque(Native, i, q);
		}

		public void AddJointTorqueMultiDof(int i, Scalar[] q)
		{
			btMultiBody_addJointTorqueMultiDof(Native, i, q);
		}

		public void AddJointTorqueMultiDof(int i, int dof, Scalar q)
		{
		...
		public void ApplyDeltaVeeMultiDof(Scalar deltaVee, Scalar multiplier)
		{
			btMultiBody_applyDeltaVeeMultiDof(Native, deltaVee.Native, multiplier);
		}

		public void ApplyDeltaVeeMultiDof2(Scalar deltaVee, Scalar multiplier)
		{
			btMultiBody_applyDeltaVeeMultiDof2(Native, deltaVee.Native, multiplier);
		}

		public void CalcAccelerationDeltasMultiDof(Scalar force, Scalar output, AlignedObjectArray<Scalar> scratchR,
		...
		*/
		...
		public void CheckMotionAndSleepIfRequired(Scalar timestep)
		{
		...
		/*
		public void ComputeAccelerationsArticulatedBodyAlgorithmMultiDof(Scalar deltaTime,
			AlignedObjectArray<Scalar> scratchR, AlignedObjectArray<btVector3> scratchV,
		...
		public void FillConstraintJacobianMultiDof(int link, Vector3 contactPoint,
			Vector3 normalAng, Vector3 normalLin, Scalar jac, AlignedObjectArray<Scalar> scratchR,
		...
		public void FillContactJacobianMultiDof(int link, Vector3 contactPoint, Vector3 normal,
			Scalar jac, AlignedObjectArray<Scalar> scratchR, AlignedObjectArray<btVector3> scratchV,
		...
		*/
		...
		public Scalar GetLinkMass(int i)
		{
		...
		public void SetJointPos(int i, Scalar q)
		{
			btMultiBody_setJointPos(Native, i, q);
		}

		public void SetJointPosMultiDof(int i, Scalar[] q)
		{
			btMultiBody_setJointPosMultiDof(Native, i, q);
		}

		public void SetJointVel(int i, Scalar qdot)
		{
			btMultiBody_setJointVel(Native, i, qdot);
		}

		public void SetJointVelMultiDof(int i, Scalar[] qdot)
		{
		...
		public void SetupFixed(int linkIndex, Scalar mass, Vector3 inertia, int parent,
		...
		public void SetupPlanar(int i, Scalar mass, Vector3 inertia, int parent, Quaternion rotParentToThis,
		...
		public void SetupPrismatic(int i, Scalar mass, Vector3 inertia, int parent,
		...
		public void SetupRevolute(int linkIndex, Scalar mass, Vector3 inertia, int parentIndex,
			Quaternion rotParentToThis, Vector3 jointAxis, Vector3 parentComToThisPivotOffset,
		...
		public void SetupSpherical(int linkIndex, Scalar mass, Vector3 inertia, int parent,
			Quaternion rotParentToThis, Vector3 parentComToThisPivotOffset, Vector3 thisPivotToThisComOffset,
		...
		public void StepPositionsMultiDof(Scalar deltaTime, Scalar[] pq = null, Scalar[] pqd = null)
		{
			btMultiBody_stepPositionsMultiDof(Native, deltaTime, pq, pqd);
		}
		/*
		public void StepVelocitiesMultiDof(Scalar deltaTime, AlignedObjectArray<Scalar> scratchR,
			AlignedObjectArray<btVector3> scratchV, AlignedObjectArray<btMatrix3x3> scratchM,
		...
		*/
		...
		public Scalar KineticEnergy => btMultiBody_getKineticEnergy(Native);
		...
		public Scalar MaxCoordinateVelocity
		{
